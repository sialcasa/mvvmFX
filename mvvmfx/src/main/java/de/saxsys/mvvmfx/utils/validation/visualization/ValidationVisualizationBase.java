...
/**
 * A base class for implementations of {@link ValidationVisualization}s. 
 * 
 ...
 * 
 * This base class takes care for the handling of the {@link ValidationResult} and the reaction to it's changing message lists. 
 * 
 * @author manuel.mauky
 */
public abstract class ValidationVisualizationBase implements ValidationVisualization{


	@Override
	public void initVisualization(final ValidationResult result, final Control control, boolean required) {
		if(required) {
	 ...
	 * 
	 * A visualization can handle the {@link Severity} that is provided in the visualization message ({@link ValidationMessage#getSeverity()}).
	 * 
