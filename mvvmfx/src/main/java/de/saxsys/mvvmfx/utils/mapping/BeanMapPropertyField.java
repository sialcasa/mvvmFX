 ...
 */
public class BeanMapPropertyField<M, K, V, T extends ObservableMap<K, V>, R extends Property<T>>
    ...
    public BeanMapPropertyField(SideEffect updateFunction, MapGetter<M, K, V> getter, MapSetter<M, K, V> setter,
