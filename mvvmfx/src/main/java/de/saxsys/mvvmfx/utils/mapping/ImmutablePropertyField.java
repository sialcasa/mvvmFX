...
public class ImmutablePropertyField<T, M, R extends Property<T>> implements PropertyField<T, M, R> {
	...
	public ImmutablePropertyField(SideEffect updateFunction, Function<M, T> getter,
