...
/**
 * This class is used as example View class. It is used to verify that the same implicit initialization that is done for
 * fxml views by the {@link javafx.fxml.FXMLLoader} is also working for Java-written Views by the mvvmfx framework.
 */
