...
public class GCVerifier {
	 ...
	 * 
	 * 
	 * This method will only return when the GC was done. <strong>Be careful</strong>: This method will block until
	 * the GC was done so when for some reason the java runtime doesn't run the GC your application won't continue.
	 */
	@SuppressWarnings("unchecked")
