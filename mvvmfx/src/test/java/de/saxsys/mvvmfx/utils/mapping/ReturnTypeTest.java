 ...
 * See Issue 211 <a href="https://github.com/sialcasa/mvvmFX/issues/211">https://github.com/sialcasa/mvvmFX/issues/211</a>
 */
public class ReturnTypeTest {
    ...
    public void objectProperty(){
        ...
        final ObjectProperty<Person> beanFieldDefault = wrapper.field(ExampleModel::getObject, ExampleModel::setObject, new Person());
        final ObjectProperty<Person> fxFieldDefault = wrapper.field(ExampleModel::objectProperty, new Person());

        final ObjectProperty<Person> idBeanField = wrapper.field("obj1",ExampleModel::getObject, ExampleModel::setObject);
        final ObjectProperty<Person> idFxField =wrapper.field("obj2",ExampleModel::objectProperty);
        final ObjectProperty<Person> idBeanFieldDefault = wrapper.field("obj3",ExampleModel::getObject, ExampleModel::setObject, new Person());
        final ObjectProperty<Person> idFxFieldDefault = wrapper.field("obj4",ExampleModel::objectProperty, new Person());
    }
